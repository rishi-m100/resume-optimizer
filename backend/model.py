...
def main():
    ...
    resume_dir = os.path.join('/Users/rishimulchandani/resume-optimizer/backend/parsed_resumes/', file_timestamp)
    directory = '/Users/rishimulchandani/resume-optimizer/backend/job_postings/'
